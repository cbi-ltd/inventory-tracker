...
public class PumpAuditService {
    ...
    public List<PumpAuditResponse> getAllPumpAudits() {
        ...
        return pumpAuditMapper.toResponseList(pumpAuditRepository
                .findByPumpAssignment_Station_Merchant_IdOrderByBusinessDateDesc(merchant.getId()));
    }
    ...
    public List<PumpAuditResponse> getPumpAuditsByBusinessDate(LocalDate businessDate) {
        Merchant merchant = getCurrentMerchant();
        return pumpAuditMapper.toResponseList(pumpAuditRepository
                        .findByPumpAssignment_Station_Merchant_IdAndBusinessDateOrderByClockInTimeAsc(merchant.getId(),businessDate));
    }
    ...
    public List<PumpAuditResponse> filterPumpAudits(PumpAuditFilterRequest request) {
        Merchant merchant = getCurrentMerchant();
        return pumpAuditMapper.toResponseList(pumpAuditRepository.findAll(PumpAuditSpecification.filter(request, merchant.getId())));
    }
    ...
    private void verifyStationOwnership(Station station) {
        Merchant merchant = getCurrentMerchant();
        if (station == null || station.getMerchant() == null || !station.getMerchant().getId().equals(merchant.getId())) {
